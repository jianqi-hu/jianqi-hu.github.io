      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto -mt-4">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              UNIOlab focuses on ultrafast nonlinear optics and integrated photonics. Integrated photonics enables compact, energy-efficient and capable systems.
            </p>
            <p>
              We develop ultrafast sources, modulators, photodetectors and nonlinear devices for frequency combs, communications and sensing. Our research spans four directions: integrated nonlinear photonics, integrated ultrafast photonics, photonic computing, and structured light.
            </p>
          </div>
        </div>
